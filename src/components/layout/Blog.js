            ...
            <div className="mx-auto mb-10 max-w-[370px]">
              <div className="mb-8 overflow-hidden rounded">
                <img
                  className="w-full"
                  alt="blog_pic"
                  src="https://res.cloudinary.com/depljf8uc/image/upload/v1668501950/pexels-ono-kosuki-5973969_c6b8vy.jpg"
                />
              </div>
            </div>
            <div>
            ...
            <div className="mx-auto mb-10 max-w-[370px]">
              <div className="mb-8 overflow-hidden rounded">
                <img
                  className="w-full"
                  alt="blog_pic"
                  src="https://res.cloudinary.com/depljf8uc/image/upload/v1668441682/pexels-anna-shvets-4315565_zc2jjj.jpg"
                />
              </div>
            </div>
            <div>
            ...
            <div className="mx-auto mb-10 max-w-[370px]">
              <div className="mb-8 overflow-hidden rounded">
                <img
                  className="w-full"
                  alt="blog_pic"
                  src="https://res.cloudinary.com/depljf8uc/image/upload/v1668441689/pexels-suntorn-somtong-1029243_qgtbvn.jpg"
                />
              </div>
            </div>
            <div>
