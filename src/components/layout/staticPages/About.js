              ...
              <div className="w-full px-3 sm:px-4 xl:w-1/2">
                <div className="py-3 sm:py-4">
                  <img
                    ...
                    alt="about"
                    src="https://res.cloudinary.com/depljf8uc/image/upload/v1664962441/plumb-min_tg668c.gif"
                  />
                </div>
                <div className="py-3 sm:py-4">
                  <img
                    className="w-full rounded-2xl"
                    alt="about"
                    src="https://res.cloudinary.com/depljf8uc/image/upload/v1664962441/electricals-min_wgtg22.gif"
                  />
                </div>
              </div>
              <div className="w-full px-3 sm:px-4 xl:w-1/2">
                <div className="relative z-10 my-4">
                  <img
                    className="w-full rounded-2xl"
                    alt="about"
                    src="https://res.cloudinary.com/depljf8uc/image/upload/v1664962399/hardwares_yxx7hx.gif"
                  />
