...
const Ads = ({ user, setUser }) => {
  ...
  "
        ...
        <div className="relative -mx-4 flex items-center justify-between">
          <div className="w-60 max-w-full px-4">
            <a href="/">
              ...
              {/* <img
                className="w-full"
                src="https://res.cloudinary.com/depljf8uc/image/upload/v1665493967/logo/partner1_daqt8k.png"
              /> */}
            </a>
          </div>
              ...
              <nav className="absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-white py-5 px-6 shadow lg:static lg:block lg:w-full lg:max-w-full lg:shadow-none">
               ...
               ${"/" === pathname ? style.active : style.inactive}`}
                  ...
                  <li>
                    <span
                      className={`${style.link} 
               ${"/services" === pathname ? style.active : style.inactive}`}
                    >
                      <a
                        href="/services"
                        className="flex py-2 text-base font-medium text-dark hover:text-primary lg:ml-12 lg:inline-flex"
                  ...
                  <li>
                    <span
                      className={`${style.link} 
               ${"/about" === pathname ? style.active : style.inactive}`}
                    >
                      <a
                        href="/about"
                        className="flex py-2 text-base font-medium text-dark hover:text-primary lg:ml-12 lg:inline-flex"
                  ...
                  <li>
                    <span
                      className={`${style.link} 
               ${"/contact" === pathname ? style.active : style.inactive}`}
                    >
                      <a
                        href="/contact"
                        className="flex py-2 text-base font-medium text-dark hover:text-primary lg:ml-12 lg:inline-flex"
    ...
    // <>
    //   <nav className="relative px-4 py-4 flex shadow-lg justify-between items-center bg-white">
    ...
    //       <li>
    //         <a className="text-lg text-gray-700 hover:text-blue-600" href="/">
    //           Home
    //         </a>
    //       </li>
    //       <li>
    //         <a className="text-lg text-blue-700 font-semi-bold" href="/">
    //           Shops
    //         </a>
    //       </li>
    //       <li>
    ...
    //       </li>
    //       <li>
    //         <a className="text-lg text-gray-700 hover:text-blue-600" href="/about">
    //           About
    //         </a>
    //       </li>
    //       <li>
    //         <a className="text-lg text-gray-700 hover:text-blue-600" href="/contact">
    //           Contact
    //         </a>
    //       </li>
    //     </ul>
    //     <a
    //       className="hidden lg:inline-block lg:ml-auto  lg:mr-3 text-white  py-2 px-6 bg-blue-500  hover:bg-blue-600 font-bold  rounded-xl transition duration-200"
    //       href="/#"
    //     >
    //       <CartIcon />
    //     </a>
