const Content = () => (
  <div className="flex border-x-4 p-8  flex-row flex-wrap sm:flex-row">
    ...
    <div className="shadow-lg rounded-xl w-full md:w-4/12 md:ml-4 mt-8 p-4 bg-white dark:bg-gray-800 relative overflow-hidden">
      <div className="w-full flex items-center justify-between mb-8">
        <p className="text-gray-800 dark:text-white text-xl">Shops</p>
        <a
          href="/#"
      ...
      <div className="flex items-center mb-6 rounded justify-between">
        <div className="flex items-center w-full justify-between">
          <div className="flex text-sm flex-col w-full ml-2 items-start justify-between">
            <p className="dark:text-white">Tanker Shop</p>
    ...
    <div className="shadow-lg rounded-xl w-full md:w-4/12 md:ml-4 mt-8 p-4 bg-white dark:bg-gray-800 relative overflow-hidden">
      ...
      <div className="flex items-center mb-6 rounded justify-between">
        <div className="flex items-center w-full justify-between">
          <div className="flex text-sm flex-col w-full ml-2 items-start justify-between">
            <p className="dark:text-white">Tube not working</p>
            <p className="text-gray-300">David</p>
          </div>
          <span className="text-red-400">19/10/2023</span>
        </div>
      </div>
      <div className="flex items-center mb-6 rounded justify-between">
        <div className="flex items-center w-full justify-between">
    ...
    <div className="shadow-lg rounded-xl w-full md:w-5/12 md:ml-4 mt-8 p-4 bg-white dark:bg-gray-800 relative overflow-hidden">
      <div className="w-full flex items-center justify-between mb-8">
        <p className="text-gray-800 dark:text-white text-xl">Recent Orders</p>
        <a
          href="/#"
          className="flex items-center text-sm hover:text-gray-600 dark:text-gray-50 dark:hover:text-white text-gray-300 border-0 focus:outline-none"
        >
      ...
      <div className="flex items-center mb-6 rounded justify-between">
        <div class="table w-full">
          <div class="table-header-group">
            <div class="py-20 table-row">
              <div class="table-cell text-left">Product</div>
              <div class="table-cell text-left">quantity</div>
              <div class="table-cell text-left">Price</div>
              <div class="table-cell text-left">Shop</div>
            </div>
          </div>
          <div class="table-row-group text-gray-400 ">
            <div class="table-row">
              <div class="table-cell">Afritanker</div>
              <div class="table-cell">4</div>
              <div class="table-cell">4556 FRW</div>
              <div class="table-cell">Tanker</div>
            </div>
            <div class="table-row">
              <div class="table-cell">Afritanker</div>
              <div class="table-cell">4</div>
    ...
    <div className="shadow-lg rounded-xl w-full md:w-3/6 md:ml-4 mt-8 p-4 bg-white dark:bg-gray-800 relative overflow-hidden">
      <div className="w-full flex items-center justify-between mb-8">
        <p className="text-gray-800 dark:text-white text-xl">Recent Orders</p>
        <a
          href="/#"
      ...
      <div className="flex items-center mb-6 rounded justify-between">
        <div class="table w-full">
          <div class="table-header-group">
            <div class="py-20 table-row">
              <div class="table-cell text-left">Customer</div>
              <div class="table-cell text-left">phone</div>
              <div class="table-cell text-left">Total Price</div>
          ...
          <div class="table-row-group text-gray-400 ">
            <div class="table-row">
              ...
              <div class="table-cell">0787546465545</div>
              <div class="table-cell">4,556,000 FRW</div>
              <div class="table-cell">23/10/2023</div>
            </div>
            <div class="table-row">
              <div class="table-cell">Peter</div>
              <div class="table-cell">0787546465545</div>
