...
const Signup = (props) => {
  ...
  const register = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://sbg.onrender.com/api/v1/users/register", {
                  ...
                  <div className="lg:w-6/12 px-4 md:px-0">
                    <div className="md:p-12 md:mx-6">
                      ...
                      <form onSubmit={register}>
                        <p className="mb-4">Please signUp</p>
                        <p className="text-red-600 italic tracking-wide text-center uppercase">{msg}</p>
                        <div className="mb-4">
                          <input
                            type="text"
                        ...
                        <div className="flex items-center justify-between pb-6">
                          <p className="mb-0 mr-2">
                            Already have account have an account?
                          </p>
                          <Link to="/login">
                            <button
                              type="button"
